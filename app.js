...
function updateProgress(){
 ...
 const chip=$('#progressChip');chip.textContent=`התקדמות ${done}/7`;chip.setAttribute('aria-label',`${done} מתוך 7 שלבי תרגול הושלמו`);
